...
public class ResultSet implements IResultSet
{
	...
	public ResultSet(String[][] sData, IResultSetMetaData rsmd) {
	...
	{
		String value = datatable[getRow() - 1][index - 1];
	...
	{
		String s_date = datatable[getRow() - 1][index - 1];
		Date maDate = java.sql.Date.valueOf(s_date.substring(0, 10));
